...
/// The ZOrca application icon shown by macOS while the app is running.
#[derive(
    Copy,
    Clone,
    Debug,
...
pub struct SettingsContent {
    ...
    /// Configuration of audio in ZOrca.
    ...
    /// The application icon to show in the Dock and app switcher on macOS.
    pub app_icon: Option<AppIcon>,

    /// This base keymap settings adjusts the default keybindings in ZOrca to be similar
    /// to other common code editors. By default, ZOrca's keymap closely follows VSCode's
    ...
    /// This allows running multiple ZOrca instances side by side without them
    /// overwriting each other's keychain entries.
    pub credentials_url: Option<String>,

    /// Configuration for session-related features
    pub session: Option<SessionSettingsContent>,
    /// Control what info is collected by ZOrca.
    pub telemetry: Option<TelemetrySettingsContent>,

    /// Configuration of the terminal in ZOrca.
    ...
    /// Settings related to Vim mode in ZOrca.
...
/// diagnostic data about a running ZOrca instance.
#[with_fallible_options]
...
pub enum ProfileBase {
    ...
    #[default]
    User,
    /// Apply profile settings on top of ZOrca's default settings, ignoring user customizations.
    Default,
}
...
pub struct SettingsProfile {
    ...
    /// - `default`: Apply on top of ZOrca's default settings, ignoring user customizations
    #[serde(default)]
...
pub struct TelemetrySettingsContent {
    ...
    /// Send anonymized usage data like what languages you're using ZOrca with.
    ///
    /// Default: true
...
pub struct DebuggerSettingsContent {
    ...
    /// Whether the breakpoints should be reused across ZOrca sessions.
    ///
    /// Default: true
    ...
    /// Whether to log messages between active debug adapters and ZOrca
    ///
    /// Default: true
...
/// Configuration of voice calls in ZOrca.
#[with_fallible_options]
#[derive(Clone, PartialEq, Default, Serialize, Deserialize, JsonSchema, MergeFrom, Debug)]
...
pub struct FileFinderSettingsContent {
    ...
    /// Only the file ZOrca had indexed will be used, not necessary all the gitignored files.
    ///
    /// Default: Smart
...
pub enum IncludeIgnoredContent {
    ...
    All,
    /// Use only the files ZOrca had indexed
    Indexed,
...
pub struct RemoteSettingsContent {
    ...
    ///
    /// When unset, ZOrca auto-detects BuildKit by probing for the `buildx` CLI
